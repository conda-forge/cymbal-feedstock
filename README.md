...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cymbal-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12102&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cymbal-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cymbal` can be installed with:

```
conda install cymbal
```

It is possible to list all of the versions of `cymbal` available on your platform with:
